...
const RoleBadge = ({ role }: { role: UserRole }) => {
  const configs: Record<UserRole, { label: string; class: string }> = {
    ...
    USER: { label: 'Staf', class: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 border-slate-200 dark:border-slate-700' },
  ...
  return (
    <div className="space-y-8 pb-32">
      ...
      <Modal
        ...
        className="max-w-lg sm:rounded-[40px]"
      >
        {editingUser && (
          <div className="flex flex-col h-full bg-white dark:bg-slate-900 min-h-0">
            {/* Header */}
            <div className="px-5 sm:px-8 py-5 sm:py-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-800/30 shrink-0">
            ...
            {/* Body */}
            <div className="flex-1 p-5 sm:p-8 space-y-7 overflow-y-auto min-h-0">
            ...
            {/* Footer */}
            <div className="p-5 sm:p-8 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex flex-col sm:flex-row justify-end gap-3 shrink-0">
              <Button
                variant="ghost"
                onClick={closeEditModal}
