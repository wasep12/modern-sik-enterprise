...
export const DashboardLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { title: 'Work Permit', icon: PlusCircle, path: '/request', roles: ['USER'] },
      ...
      <main className="lg:pl-76 min-h-screen flex flex-col pb-24 lg:pb-6 pr-0 lg:pr-6">
        ...
        <header className="sticky top-0 lg:top-6 z-30 flex h-16 items-center justify-between px-8 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl lg:rounded-[28px] shadow-luxury ring-1 ring-white/20 dark:ring-white/5 lg:mx-0">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative">
              <div onClick={() => setShowProfileMenu(!showProfileMenu)} className="pl-1 cursor-pointer group">
                <div className="h-9 w-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[10px] font-black text-primary border border-hairline border-slate-200 dark:border-slate-700 transition-transform group-hover:scale-110 shadow-sm overflow-hidden">
        ...
        <div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[92%] sm:w-[380px] z-40 drop-shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
          <LayoutGroup>
            <nav className="bg-white/90 dark:bg-slate-950/95 backdrop-blur-2xl border border-slate-200 dark:border-white/8 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.18),0_2px_8px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.6),0_2px_12px_rgba(0,0,0,0.4)] ring-1 ring-black/4 dark:ring-white/6 p-2 flex items-center justify-between relative overflow-hidden">
